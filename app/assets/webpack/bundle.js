...
/***/ function(module, exports, __webpack_require__) {
	...
	var reactTargetDivs = document.getElementsByClassName('react-component-target');
	...
	Array.prototype.forEach.call(reactTargetDivs, function (targetDiv) {
	  ...
	  _reactDom2.default.render(_react2.default.createElement(components[componentName], componentProps), targetDiv);
	});
